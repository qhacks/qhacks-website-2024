...
export default function About() {
  ...
  return (
    <div className="flex justify-center text-white bg-[#111010]">
      ...
      {/* BACKGROUND */}
      <div className="hidden md:block absolute w-full bg-transparent">
      ...
      <div className="z-[10] md:w-[80%] md:w-[60%] flex flex-col justify-start md:mt-[6rem]">
        ...
        <div className="flex flex-row w-full justify-center bg-[#202020] md:py-[10px] pb-10 md:mt-[1rem] md:mb-[6rem] md:rounded-lg">
          <a href="/registration/about" className="w-[150px] md:w-[300px] flex justify-center items-center text-center bg-[#FAAF40] rounded-lg py-2 md:py-3">Previous Page</a>
          <div className="h-full w-[2px] bg-white mx-[1rem]"></div>
          <a href="/registration/application" className="w-[150px] md:w-[300px] flex justify-center items-center text-center bg-[#EE4036] rounded-lg py-2 md:py-3">Next Page</a>
        </div>
      </div>
    </div>
  );

        ...
        <div className=' flex flex-row justify-between'>
          <div className='flex items-center'>
            <div className='flex-None flex-colitems-center justify-center'>
              <h1 className="text-white m-5 text-[100px] lg:[140px] font-bold font-Yaro ">QHACKS</h1>
              {/* <Qhacks3DText/> */}
              <p className= 'text-white m-5 text-[24px]  lg:[100px] lg:w-96 p-2'>Get ready to innovate and make a difference! Join QHacks, the ultimate hackathon experience.</p>
          ...
          <motion.div className=" w-[750px] h-[500px] hidden md:block" whileInView={{ opacity: 1 }} >
            <Crown/>
          </motion.div>
        </div>
      </section>

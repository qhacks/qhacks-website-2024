...
export default function SignUp() {
    return ( 
        <div className='h-[800px]'>
            <form id='signup-container' className='flex flex-col justify-center items-center
             bg-waves w-full h-1/4 bg-repeat-x bg-bottom h-full' style={{
            ...
            <div id="signup-card" className='z-[1] p-[50px] bg-zinc-900 rounded-[15px] flex flex-col justify-center items-center gap-[30px]'>
                ...
                <input type="submit" value="Create Account" className='font-semibold w-[280px] text-xl text-white px-5 py-3 rounded-xl' style={{

...
function ApplicationLinkButton(props) {
    return <div className='w-full h-[55px] bg-[#474747] rounded-[15px] my-2 flex flex-row justify-between items-center px-4 text-white text-lg font-medium'>{props.title}
    {
            {
                0: <a href={props.dest} className='bg-[#3A3A3A] cursor-pointer text-white w-[40px] h-[40px] rounded-[50%] flex justify-center items-center'> GO </a>,

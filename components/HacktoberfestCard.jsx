...
export default function HacktoberfestCard() {
            ...
            <div  className="2xl:px-3 flex justify-center">
                <div className="text-center p-4">
                    <h4 className="text-white 2xl:text-2xl font-bold">
                        RSVP to our Hacktoberfest Event!
                    </h4>
                    <a
                        href="https://forms.gle/YR4pCfrefvmvqonP9"
                        className="text-white hover:text-sky-500"
                        target="_blank"
                    >
                        <motion.p whileHover={{scale:1.1}} className="2xl:text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-600">RSVP Here</motion.p>
                    </a>
                </div>
            </div>
        </div>
